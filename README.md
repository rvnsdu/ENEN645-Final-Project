...
The nnU-Net-based model demonstrates strong performance in identifying CT calibration rods with accuracy comparable to manual segmentation. The project provides a scalable alternative to manual segmentation of calibration rods for phantom-based quantitative CT workflows. Documentation outlining the nnU-Net v2 framework can be found on the [nnU-Net v Official GitHub Repository](https://github.com/MIC-DKFZ/nnUNet/blob/master/readme.md)
